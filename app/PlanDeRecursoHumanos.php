...
class PlanDeRecursoHumanos extends Model
{
    //
     ...
     */
    protected $fillable = [
        'id_plan_empresa','organigrama', 'convenio_aplicable','tipos_contrato','coste_salarial','clientes','proveedores','politica_precios','ubi_emplazamiento','ubi_transporte','ubi_plano',
